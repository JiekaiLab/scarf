...
from .data_collator_modified import DataCollatorForLanguageModeling_Inference
import time
...
# with open(Path(__file__).parent / "token_dictionary.pickle", "rb") as f:
#     token_dictionary = pickle.load(f)
# with open("/public/home/t_lgl/ia_lgl/preprocess/dict_data/hm_ENSG2token_dict.pickle", "rb") as f:
#     token_dictionary = pickle.load(f)
...
class PreCollator(SpecialTokensMixin):
    def __init__(self, *args, **kwargs) -> None:
        ...
        # ]
        self.model_input_names = ["input_ids", "values", "atac_gene_ids"]
...
class Pretrainer(Trainer):
    def __init__(self, *args, **kwargs):
        ...
        if data_collator is None:
            precollator = PreCollator(token_dictionary=token_dictionary)
        ...
        if 'example_lengths_file' in kwargs:
            example_lengths_file = kwargs.pop("example_lengths_file")
        else:
            example_lengths_file = None
...
class CustomDistributedLengthGroupedSampler(DistributedLengthGroupedSampler):
    ...
    def __init__(
        ...
        self.model_input_name = (
            model_input_name if model_input_name is not None else "rna_gene_ids"
        )
        # if 'rna_lengths' in dataset[0]:
        #     lengths = dataset['rna_lengths']
